...
public class ESNiceSpinner extends TextView {
    ...
    private ESNiceSpinnerBaseAdapter mAdapter;
    private AdapterView.OnItemClickListener mOnItemClickListener;
    private AdapterView.OnItemSelectedListener mOnItemSelectedListener;
    private boolean mHideArrow;

    @SuppressWarnings("ConstantConditions")
    public ESNiceSpinner(Context context) {
        super(context);
        init(context, null);
    }

    public ESNiceSpinner(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public ESNiceSpinner(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.ESNiceSpinner);
        ...
        mHideArrow = typedArray.getBoolean(R.styleable.ESNiceSpinner_hideArrow, false);
        if (!mHideArrow) {
            Drawable basicDrawable = ContextCompat.getDrawable(context, R.drawable.arrow);
            int resId = typedArray.getColor(R.styleable.ESNiceSpinner_arrowTint, -1);
    ...
    public <T> void attachDataSource(@NonNull List<T> dataset) {
        mAdapter = new ESNiceSpinnerAdapter<>(getContext(), dataset);
        setAdapterInternal(mAdapter);
    }

    public void setAdapter(@NonNull ListAdapter adapter) {
        mAdapter = new ESNiceSpinnerAdapterWrapper(getContext(), adapter);
        setAdapterInternal(mAdapter);
    }

    private void setAdapterInternal(@NonNull ESNiceSpinnerBaseAdapter adapter) {
